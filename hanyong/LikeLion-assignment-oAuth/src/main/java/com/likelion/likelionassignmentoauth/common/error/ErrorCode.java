package com.likelion.likelionassignmentoauth.common.error;
...
public enum ErrorCode {
    ...
    POST_NOT_FOUND_EXCEPTION(HttpStatus.NOT_FOUND, "해당 게시물 없습니다. postId = ", "NOT_FOUND_404"),
    ...
    NO_AUTHORIZATION_EXCEPTION(HttpStatus.FORBIDDEN, "접근 권한이 없습니다.", "BAD_REQUEST_403");
